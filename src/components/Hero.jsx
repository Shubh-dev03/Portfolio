      ...
      <section>
        <div className="px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex flex-col max-w-xl">
            ...
            <h2 className="text-[#7c3aed] text-3xl font-bold mt-6 mb-6">
              &#47;&#47; <span className="text-slate-500">Problem Solver</span>
            </h2>
            <p className="text-balance text-[#9ca3af] text-base leading-[1.6]">
          ...
          <div className="relative flex items-center justify-center w-[280px] h-[280px] md:w-[350px] md:h-[350px] shrink-0">
            ...
            <div className="absolute -top-4 -right-4 bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-white/10 shadow-lg">
